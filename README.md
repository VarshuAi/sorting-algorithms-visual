...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/sorting-algorithms-visual.git
   cd sorting-algorithms-visual
   ```
...
[![Repo](https://img.shields.io/badge/sorting-algorithms-visual-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/sorting-algorithms-visual)
